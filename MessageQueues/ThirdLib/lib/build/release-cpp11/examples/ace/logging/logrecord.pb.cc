...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&process_start_time_) - reinterpret_cast<char*>(this)),
...
void LogRecord_Heartbeat::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<LogRecord_Heartbeat *>(to)->MergeFrom(
      static_cast<const LogRecord_Heartbeat &>(from));
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&heartbeat_) - reinterpret_cast<char*>(this)),
